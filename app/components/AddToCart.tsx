		...
		<div className="add-to-cart">
			{inCart ? (
				<div className="cart-qty flex items-center justify-between w-24">
					<a className={`qty-change decrease text-xl ${qty === 1 ? "disabled" : ""}`} onClick={handleDecrease}>
						-
					</a>
					<input
						type="text"
				...
				<div className="hover:opacity-90">
					<a className="btn add-to-cart cursor-pointer" onClick={() => handleAddToCart(productId, 1)}>
